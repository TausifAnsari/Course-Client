    ...
    const HomePage = () => {
      return(
        <Home dish={this.props.dishes.dishes.filter((dish) => dish.featured)[0]}
          ...
          leader2={this.props.dishes.dishes.filter((dish) => dish.featured)[3]}
          leaderLoading2={this.props.dishes.isLoading}
          leaderErrMess2={this.props.dishes.errMess}
          leader3={this.props.dishes.dishes.filter((dish) => dish.featured)[4]}
          leaderLoading3={this.props.dishes.isLoading}
          leaderErrMess3={this.props.dishes.errMess}
          leader1={this.props.dishes.dishes.filter((dish) => dish.featured)[5]}
          leaderLoading1={this.props.dishes.isLoading}
      ...
      return(
        ...
        <DishDetail dish={this.props.dishes.dishes.filter((dish) => dish._id === match.params.dishId)[0]}
          ...
          favorite={
            ...
            this.props.favorites.enrolled.dishes.some((dish) => dish._id === match.params.dishId)
            : 
            null
          }
